...
declare module Phaser {
    ...
    class BitmapData {
        ...
        copy(source?: any, x?: number, y?: number, width?: number, height?: number, tx?: number, ty?: number, newWidth?: number, newHeight?: number, rotate?: number, anchorX?: number, anchorY?: number, scaleX?: number, scaleY?: number, alpha?: number, blendModes?: string, roundPx?: boolean): Phaser.BitmapData;
        copyPixels(source: any, area: Phaser.Rectangle, x: number, y: number, alpha?: number): void;
        copyRect(source: any, area: Phaser.Rectangle, x?: number, y?: number, alpha?: number, blendModes?: string, roundPx?: boolean): Phaser.BitmapData;
        copyTransform(source: any, blendModes?: string, roundPx?: boolean): Phaser.BitmapData;
        destroy(): void;
        draw(source: any, x?: number, y?: number, width?: number, height?: number, blendModes?: string, roundPx?: boolean): Phaser.BitmapData;
        drawFull(parent: any, blendModes?: string, roundPx?: boolean): Phaser.BitmapData;
        drawGroup(group: Phaser.Group, blendModes?: string, roundPx?: boolean): Phaser.BitmapData;
    ...
    class Create {
        ...
        copy(dest?: Phaser.BitmapData, x?: number, y?: number, width?: number, height?: number, blendModes?: string, roundPx?: boolean): Phaser.BitmapData;
    ...
    export class Video {
        ...
        resizeFrame(parent: any, width: number, height: number): void;
        setTouchLock(): void;
        grab(clear?: boolean, alpha?: number, blendModes?: string): Phaser.BitmapData;
        stop(): void;
        unlock(): boolean;
